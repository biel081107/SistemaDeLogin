        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cpf = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPeca = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    NomePeca = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdServico = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    IdCliente = table.Column<int>(type: "INTEGER", nullable: false),
                    NomeAparelho = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    DefeitoInformado = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    Diagnostico = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    Status = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 0),
                    Valor = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    DataDeEntrada = table.Column<DateTime>(type: "date", nullable: false),
                    PrevisaoDeEntrega = table.Column<DateTime>(type: "date", nullable: false)
                },
                constraints: table =>
                {
